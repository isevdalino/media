            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse navigation-bar">
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item">
                            <button className="nav-link logout-button-style" style={logoutVisibilityStyleSheet(isUserLoggedInState)} onClick={() => { onLogoutClick(history, setIsUserLoggedInState) }}>Logout</button>
                        </li>
                    </ul>
                    <ul className="navbar-nav ml-auto">
                        <SearchBar />
